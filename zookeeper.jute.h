...
int serialize_ACL(struct oarchive* out, const char* tag, struct ACL2* v);
int deserialize_ACL(struct iarchive* in, const char* tag, struct ACL2* v);
void deallocate_ACL(struct ACL2);
struct Stat {
    int64_t czxid;
    int64_t mzxid;
    int64_t ctime;
